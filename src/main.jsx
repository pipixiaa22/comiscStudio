...
class RootErrorBoundary extends Component {
    ...
    render() { return this.state.error ? <main className="grid min-h-screen place-items-center bg-[#0f1219] p-6 text-center text-slate-200"><div><b>界面启动失败</b><p className="mt-2 text-sm text-slate-400">{this.state.error.message || '请重启应用后重试'}</p></div></main> : this.props.children }
}
