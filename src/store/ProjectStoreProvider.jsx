...
export function ProjectStoreProvider({ children }) {
  ...
  const commands = useMemo(() => ({
    ...
    updateBlockText: (blockId, text) => dispatch(projectActions.updateText(blockId, text, Date.now())), completeCurrentBlock: () => dispatch(projectActions.complete()), completeAndAddBlock: () => dispatch(projectActions.completeAndAdd()), addBlock: () => dispatch(projectActions.addBlock()),
    ...
    removeAsset: (blockId, assetId) => dispatch(projectActions.removeAsset(blockId, assetId)), moveAsset: (blockId, assetId, toIndex) => dispatch(projectActions.moveAsset(blockId, assetId, toIndex)), toggleFavorite: sourceId => dispatch(projectActions.toggleFavorite(sourceId)), addBasketItem: (sourceId, crop) => dispatch(projectActions.addBasketItem(sourceId, crop)), removeBasketItem: itemId => dispatch(projectActions.removeBasketItem(itemId)), reorderBasket: (itemId, toIndex) => dispatch(projectActions.reorderBasket(itemId, toIndex)), clearBasket: () => dispatch(projectActions.clearBasket()), addBasketItemToBlock: (itemId, blockId) => dispatch(projectActions.addBasketItemToBlock(itemId, blockId)), setBlockStatus: (blockId, key, value) => dispatch(projectActions.setBlockStatus(blockId, key, value)), setNarrationMode: mode => dispatch(projectActions.setNarrationMode(mode)), addVoiceTake: (blockId, take) => dispatch(projectActions.addVoiceTake(blockId, take)), setActiveVoiceTake: (blockId, takeId) => dispatch(projectActions.setActiveVoiceTake(blockId, takeId)), setNarrationRequired: (blockId, required) => dispatch(projectActions.setNarrationRequired(blockId, required)), setVoiceTrim: (blockId, trimStartMs, trimEndMs) => dispatch(projectActions.setVoiceTrim(blockId, trimStartMs, trimEndMs)), removeVoiceTake: (blockId, takeId) => dispatch(projectActions.removeVoiceTake(blockId, takeId)),
