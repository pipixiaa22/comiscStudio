...
export function ProjectStoreProvider({children}) {
    ...
    const commands = useMemo(() => ({
        ...
        mergeWithNext: blockId => dispatch(projectActions.mergeWithNext(blockId)),
        bulkBlocks: (blockIds, operation) => dispatch(projectActions.bulkBlocks(blockIds, operation)),
        selectNextTodo: kind => dispatch(projectActions.selectNextTodo(kind)),
