...
export function WorkspacePage({ project, sources, filteredSources, sourcesById, selectedSource, search, onSearchChange, onSelectSource, onOpenReader, browserView, onBrowserViewChange, favoriteIds, onToggleFavorite, onAddBasket, onAddAsset, usageIndex, onSelectReference, onLocateAsset, selectedAssetId, onSelectAsset, block, blockIndex, blocks, commands, undoCount, redoCount }) {
