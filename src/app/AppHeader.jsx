import { BookOpen, Download, FolderOpen, Save, PanelsTopLeft } from 'lucide-react'
import { Button } from '../components/ui/button'
import { ProjectProgress } from '../features/project/components/ProjectProgress'

export function AppHeader({ project, saveStatus, view, onViewChange, onSave, onImport, onExport, narrationMode, onNarrationMode }) {
