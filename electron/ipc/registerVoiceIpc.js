...
function registerVoiceIpc({ ipcMain, voiceRecordingService, localMediaService }) {
  ...
  ipcMain.handle('voice:take-url', (_, input) => result(() => localMediaService.register('audio', voiceRecordingService.resolveTake(input)).url))
