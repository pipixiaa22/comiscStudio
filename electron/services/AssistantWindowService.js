...
class AssistantWindowService {
  ...
  async open() {
    ...
    const window = this.window = new BrowserWindow({ width, height, x, y, minWidth: 340, minHeight: 420, title: 'MangaDesk 剪映辅助', backgroundColor: '#11141c', autoHideMenuBar: true, webPreferences: { preload: this.preload, contextIsolation: true, nodeIntegration: false } })
